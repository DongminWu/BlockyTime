...
class day_controller_tester(object):
    ...
    def testing_get_date_object_from_string(self):
        ...
        '''
        day_con_true = day_controller('2017-03-10', '0')
        assert isinstance(day_con_true.get_date(), Date)
        day_con_false = day_controller('2017-03-01', '0')
        assert day_con_false.get_date() is None
        day_con_false = day_controller('2017-03-10', '1')
        assert day_con_false.get_date() is None
    ...
    def testing_update_date_data(self):
        ...
        query_day_con = day_controller('2017-03-10', '0')
