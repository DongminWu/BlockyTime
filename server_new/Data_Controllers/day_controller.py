...
class day_controller(object):
    ...
    def get_date_list(self):
        ...
        if self.date is None:
            ...
            ret['last_changed_time'] = ret['last_changed_time'].strftime("%Y-%m-%d %H:%M:%S")
            return ret
